    ...
    stages {
        ...
        stage ('Run Docker') {
            ...
            steps {
                ...
                sh ("docker cp /var/lib/jenkins/workspace/weblogic-multibranch_master/target/websocket-demo-0.0.1-SNAPSHOT.war weblogic${env.BRANCH_NAME}${currentBuild.number}:/u01/oracle/weblogic/user_projects/domains/base_domain/autodeploy")
            }
        }
